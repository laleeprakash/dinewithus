...
function About() {
  return (
    <div
      className="bg-gradient-to-r from-purple-500 to-indigo-700 text-white"
    >
      <div
      ...
      >
        ...
        <h1 className="font-extrabold text-5xl text-center mb-11 text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 to-red-300 relative group drop-shadow-lg">
          About Us
          {/* Custom decorative underline with semi-transparent color matching the image */}
        ...
        <div className="flex justify-center w-full mb-10">
          <h3 className="text-lg font-semibold text-teal-200 text-center w-full md:w-[75%] drop-shadow-md hover:text-teal-300 transition-colors duration-300">
        ...
        {/* Our Mission */}
        <h1 className="font-semibold text-3xl text-center mb-6 text-emerald-200 drop-shadow-lg hover:text-emerald-300 transition-colors duration-300">
          Our Mission
        </h1>
        ...
        <ul className="list-disc pl-5 text-lg text-slate-100 space-y-3 mb-10 drop-shadow-sm hover:text-slate-300 transition-colors duration-300">
        ...
        <ol className="list-decimal pl-5 text-lg text-slate-100 space-y-3 mb-10 drop-shadow-sm hover:text-slate-300 transition-colors duration-300">
...
<div className="text-center mt-16">
  <div className="bg-gradient-to-r from-gray-800 via-transparent to-gray-800 p-8 rounded-lg border-4 border-gray-200 shadow-lg max-w-xl mx-auto transition-all duration-300 hover:shadow-2xl hover:scale-10 transform hover:rotate-0">
